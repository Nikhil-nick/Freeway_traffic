  #include<GL/glut.h>
	...
	float g=10; // car translate indicator speed
	...
	declare("******************************** NIKHIL '`'|'_`|'`' NIKHIL KULKARNI *********************************");
	}
	...
	glPushMatrix();
	glTranslatef(1720.0,930.0,0.0);
	glutSolidSphere(1.0,200,200);
	glPopMatrix();
	
	glBegin(GL_POLYGON); // car
	glColor3f(1.2,0.8,0.5);
	glVertex2f(1700.0,950.0);
	glVertex2f(1850.0,950.0);
	glVertex2f(1850.0,1050.0);
	glVertex2f(1700.0,1050.0);
	glEnd();
	
	glBegin(GL_POLYGON); // car
	glColor3f(0.0,0.0,1.0);
	glVertex2f(1670.0,930.0);
	glVertex2f(1700.0,950.0);
	glVertex2f(1700.0,1050.0);
	glVertex2f(1670.0,1030.0);
	glEnd();
	
	glBegin(GL_POLYGON); // car
	glColor3f(0.0,0.0,1.0);
	glVertex2f(1670.0,930.0);
	glVertex2f(1830.0,930.0);
	glVertex2f(1850.0,950.0);
	glVertex2f(1700.0,950.0);
	glEnd();
	...
	glBegin(GL_LINES);
	glColor3f(0.0,0.0,0.0);
	glVertex2f(1720.0,980.0);
	glVertex2f(1820.0,980.0);
	glVertex2f(1820.0,980.0);
	glVertex2f(1820.0,1010.0);
	glVertex2f(1820.0,1010.0); //carrier
	glVertex2f(1720.0,1010.0);
	glVertex2f(1720.0,1010.0);
	glVertex2f(1720.0,980.0);
	glVertex2f(1740.0,980.0);
	glVertex2f(1740.0,1010.0);
	glVertex2f(1760.0,980.0);
	glVertex2f(1760.0,1010.0);
	glVertex2f(1780.0,980.0);
	glVertex2f(1780.0,1010.0);
	glVertex2f(1700.0,980.0);
	glVertex2f(1700.0,1010.0);
	glEnd();
	
	glBegin(GL_LINES);
	glColor3f(1.0,0.0,1.0);
	glVertex2f(1680.0,935.0); //head lamp
	glVertex2f(1680.0,945.0);
	glEnd();
	
	glBegin(GL_LINES);
	glColor3f(1.0,0.0,1.0);
	glVertex2f(1680.0,1025.0); //head lamp
	glVertex2f(1680.0,1035.0);
	glEnd();
	
	glBegin(GL_LINES);
	glColor3f(1.0,0.0,1.0);
	glVertex2f(1690.0,955.0); //horn grill
	glVertex2f(1690.0,1025.0);
	glEnd();
	
	glBegin(GL_LINES);
	glColor3f(1.0,0.0,1.0);
	glVertex2f(1700.0,940.0); //side window
	glVertex2f(1828.0,940.0);
	glEnd();
